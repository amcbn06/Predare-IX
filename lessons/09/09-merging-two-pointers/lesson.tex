...
\begin{frame}{Algoritmul}
  ...
  \smallskip
  \textbf{Exemplu:} $a = [1,\ 3,\ 5,\ 8]$, $b = [2,\ 4,\ 6,\ 7]$:
  ...
  \matrix[matrix of nodes, nodes in empty cells, ampersand replacement=\&,
    ...
    |[font=\small\bfseries]| $a$
      \& |[fill=orange!40]| 1 \& |[fill=blue!15]| 3 \& |[fill=blue!15]| 5 \& |[fill=blue!15]| 8 \\
    |[font=\small\bfseries]| $b$
      \& |[fill=blue!30]| 2 \& |[fill=blue!15]| 4 \& |[fill=blue!15]| 6 \& |[fill=blue!15]| 7 \\
  };
  \end{tikzpicture}
  ...
  \matrix[matrix of nodes, nodes in empty cells, ampersand replacement=\&,
    ...
    |[font=\small\bfseries]| $c$
      ...
      \& |[fill=green!25]| 7 \& |[fill=green!25]| 8 \\
  };
  \end{tikzpicture}
  \end{center}
...
\begin{frame}[fragile, shrink]{Implementare \textemdash{} Sliding Window}
  \begin{lstlisting}
...
\begin{frame}{Resurse}
  \begin{itemize}\itemsep6pt
    ...
    \item \href{https://cses.fi/book/book.pdf}{\textbf{Competitive Programmer's Handbook}} \textemdash{} cap. 8 (EN)
  \end{itemize}
\end{frame}
...
\begin{frame}{Probleme de antrenament \textemdash{} Two Pointers}
