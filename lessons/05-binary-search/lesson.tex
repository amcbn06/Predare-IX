...
% pentru clasa a 9-a:
\subtitle{Varianta clasică $\cdot$ Variații $\cdot$ STL $\cdot$ Complexitate \\ Căutare binară pe răspuns}
...
\begin{frame}{Recapitulare}
  ...
  \begin{tabular}{lll}
    ...
    Căutare binară pe răspuns     & $O(\log n \cdot f(n))$ & depinde \\ 
    \bottomrule
  \end{tabular}
  \end{center}
...
\begin{frame}[shrink]{Probleme de antrenament}
  \begin{block}{Ușoare}
    \begin{itemize}
